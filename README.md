...
### Docker container </br>
```
docker run -d --name tModLoader1.4 -p 7777:7777 -v (path to server files):/server passivelemon/tmodloader1.4-docker:2022.08.54.6
```
 ...
 - `passivelemon/tmodloader1.4-docker:2022.08.54.6` is my repository on DockerHub. If you want a different version, change the numbers at the end.
</br>
