...
### Docker container </br>
```
docker run -d --name tModLoader1.4 -p 7777:7777 -v (path to server files):/server passivelemon/tmodloader1.4-docker:2022.09.47.9
```
 ...
 - `passivelemon/tmodloader1.4-docker:2022.09.47.9` is my repository on DockerHub. If you want a different version, change the numbers at the end.
</br>
